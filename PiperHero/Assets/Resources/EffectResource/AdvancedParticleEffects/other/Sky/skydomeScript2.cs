...
public class skydomeScript2 : MonoBehaviour {
    ...
    public float m_fRayFactor = 989.0f;
	public float m_fMieFactor =  0.5f;
    public float m_fDirectionalityFactor = 0.67f;
    public float m_fSunColorIntensity = 0.9f;
	
	private float seconds=60000.0f;
	//private float cur_hour;
